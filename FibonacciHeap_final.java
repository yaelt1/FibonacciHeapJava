 ...
 */
public class FibonacciHeap_final {
     ...
     */
    public void meld(FibonacciHeap_final heap2) {  //O(1)
        if (this.isEmpty()){
     ...
     */
    public static int[] kMin(FibonacciHeap_final H, int k) {
        if (k==0){return new int[0];}
        int[] arr = new int[k];
        FibonacciHeap_final aidHeap = new FibonacciHeap_final();
    ...
    public static void main(String[] args){
        FibonacciHeap_final heap = new FibonacciHeap_final();
